...
namespace JeffersonGoncalves\FilamentBenefit\Concerns;

/**
 * Shared make()/get() factory helpers, the navigation-group override and the
 * swappable resource override-map plumbing for the Benefit plugin.
 */
trait HasBenefitPluginConfig
{
    ...
    public function getNavigationGroup(): ?string
    {
        return $this->navigationGroup
            ?? config('filament-benefit.navigation_group', __('filament-benefit::benefit.navigation_group'));
    }
    ...
    protected function resolveResources(array $defaults): array
    {
        ...
        $overrides = config('filament-benefit.resources', []);
