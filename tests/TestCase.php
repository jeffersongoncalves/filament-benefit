...
namespace JeffersonGoncalves\FilamentBenefit\Tests;
...
use JeffersonGoncalves\Benefit\BenefitServiceProvider;
use JeffersonGoncalves\FilamentBenefit\FilamentBenefitServiceProvider;
use JeffersonGoncalves\FilamentBenefit\Tests\Fixtures\TestPanelProvider;
use JeffersonGoncalves\FilamentBenefit\Tests\Fixtures\TestUser;
...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function getPackageProviders($app): array
    {
        return [
            ...
            FilamentBenefitServiceProvider::class,
    ...
    protected function defineDatabaseMigrations(): void
    {
        ...
        $this->loadBenefitVendorMigrations([
    ...
    /**
     * Copy the vendored `*.php.stub` migrations for `jeffersongoncalves/laravel-benefit`
     ...
     */
    protected function loadBenefitVendorMigrations(array $migrations): void
    {
        $tempPath = sys_get_temp_dir().'/filament-benefit-vendor-migrations';
        ...
        $base = InstalledVersions::getInstallPath('jeffersongoncalves/laravel-benefit');
